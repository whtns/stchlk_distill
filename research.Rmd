...
t = CV$entries_data %>%
  ...
  fill(start) %>%
  rowwise() %>%
  # mutate(pdf = glue::glue('<a href = "images/{loc}" id="pdflink"><button id="pdfbutton">Author PDF</button></a>'),
...
DT::datatable(t,
              ...
              rownames = FALSE,
              class="compact hover",
              option = list(pageLength = 10, lengthChange = FALSE, searching = FALSE, info = FALSE))
