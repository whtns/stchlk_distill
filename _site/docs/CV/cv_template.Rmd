...
<div id="intro">
Title, Department
<span style="font-size:0.9rem;">School, University</span>  
`r fontawesome::fa("envelope")` email@email.edu `r knitr::asis_output("\U00B7")`
`r fontawesome::fa("globe")` [website.com](https://website.com) `r knitr::asis_output("\U00B7")`
`r fontawesome::fa("graduation-cap")` [Google Scholar](https://scholar.google.com)  
`r fontawesome::fa("orcid")` [orcidID](https://orcid.org/) `r knitr::asis_output("\U00B7")` 
`r fontawesome::fa("github")` [Github](https://github.com/) `r knitr::asis_output("\U00B7")` 
`r fontawesome::fa("github")` [Twitter](https://twitter.com/)  
