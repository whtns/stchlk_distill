...
<div id="intro">
Ph.D Candidate, Cancer Biology and Genomics  
...
`r fontawesome::fa("globe")` [stchlk.rbind.io](https://stchlk.rbind.io) `r knitr::asis_output("\U00B7")`
...
`r fontawesome::fa("github")` [bluesky](https://bsky.app/profile/stchlk.bsky.social)  
